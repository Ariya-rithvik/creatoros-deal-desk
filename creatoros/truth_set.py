# NOTICE: vendored, unmodified copy of Veridemo Watch's fact engine
# (veridemo-watch/api/agents/orchestrator/truth_set.py). CreatorOS uses it for hashed, citable facts and the
# numeric-support guard `verify_claim`. Keep in sync by re-copying; do not edit here.
